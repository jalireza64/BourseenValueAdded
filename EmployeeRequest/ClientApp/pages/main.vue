<template>
    <div class="app rtl">
        <ul class="bg-bubbles" v-show="this.$router.currentRoute.fullPath.startsWith('/account/login') || this.$router.currentRoute.fullPath.startsWith('/account/managementLogin')">
            <li></li>
            <li></li>
            <li></li>
            <li></li>
        ...
        <header>
            <div to="/" style="display:flex; align-items:center;padding-right:8px;" v-show="!isLoginPage()">
                <button @click.prevent="$router.back()" style="color:white;outline:none;cursor:pointer">
                    <i class="fas fa-arrow-right fa-2x"></i>
                </button>
            </div>
            <div to="/" style="display:flex;margin-right:8px; align-items:center" v-show="isLoginPage()">
                <img v-bind:src="logo" />
        ...
        <nav class="k-content" id="navigation" v-show="!isLoginPage() && headerModel.UserType == 2" @click="navigate" @focusout="navFocusOut">
            <ul>
                <li>
                    <button class="k-content">
                        <i class="far fa-building"></i>
                        <span>{{$CaptionsLibrary.get('MeetingHolding')}}</span>
                    </button>
                    <ul class="k-alt">
                        <li>
                            <button class="k-content">
                                <span>{{$CaptionsLibrary.get('PresenceManagement')}}</span>
                            </button>
                            <ul>
                                <li class="k-content">
                                    <router-link to="/meeting/managementMeetingHolding">
                                        <i class="fas fa-sign-in-alt fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('MeetingEntry')}}</span>
                                    </router-link>
                                </li>
                                <li class="k-content">
                                    <router-link to="/meeting/managementMeetingVoting">
                                        <i class="fas fa-vote-yea fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('Voting')}}</span>
                                    </router-link>
                                </li>
                                <li class="k-content">
                                    <router-link to="/meeting/managementMeetingQuestions">
                                        <i class="far fa-question-circle fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('Question')}}</span>
                                    </router-link>
                                </li>
                            </ul>
                        </li>
                ...
                <li>
                    ...
                    <ul class="k-alt">
                        <li>
                            ...
                            <ul>
                                <li class="k-content">
                                    <router-link to="/basicInfo/shrMeeting">
                                        <i class="far fa-file-alt fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('Meeting')}}</span>
                                    </router-link>
                                </li>
                                <li class="k-content">
                                    <router-link to="/basicInfo/shrhVoteSub">
                                        <i class="fas fa-file-invoice fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('MeetingSubject')}}</span>
                                    </router-link>
                                </li>
                                <li class="k-content">
                                    <router-link to="/basicInfo/svotItem">
                                        <i class="fas fa-file-invoice fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('VotingOptions')}}</span>
                                    </router-link>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li class="k-content">
                                    <router-link to="/account/managementUser">
                                        <i class="fas fa-users fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('Management')}}</span>
                                    </router-link>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <button class="k-content">
                                <span>{{$CaptionsLibrary.get('Update')}}</span>
                            </button>
                            <ul>
                                <li class="k-content">
                                    <router-link to="/basicInfo/syncFromSeasonSys">
                                        <i class="fas fa-database fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('SeasonSystemGroupSys')}}</span>
                                    </router-link>
                                </li>
                            </ul>
                        </li>
                ...
                <li>
                    ...
                    <ul class="k-alt">
                        <li>
                            ...
                            <ul>
                                <li class="k-content">
                                    <router-link to="/report/rptMeetingPresence">
                                        <i class="fa fa-table fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('MeetingPresence')}}</span>
                                    </router-link>
                                </li>
                                <li class="k-content">
                                    <router-link to="/report/rptMeetingVote">
                                        <i class="fa fa-table fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('VoteState')}}</span>
                                    </router-link>
                                </li>
                                <li class="k-content">
                                    <router-link to="/report/rptMeetingVoteTotal">
                                        <i class="fa fa-table fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('TotalVoteState')}}</span>
                                    </router-link>
                                </li>
                                <li class="k-content">
                                    <router-link to="/report/rptMeetingState">
                                        <i class="fa fa-table fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('MeetingState')}}</span>
                                    </router-link>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul>
                                <li class="k-content">
                                    <router-link to="/reports/rpt43">
                                        <i class="fa fa-table fa-2x"></i>
                                        <span>{{$CaptionsLibrary.get('UsersState')}}</span>
                                    </router-link>
                                </li>
                            </ul>
                        </li>
